...
const MyEnrollments = () => {
  ...
  return (
    <>
      <div className="md:px-36 px-8 pt-10 min-h-screen bg-[#1E1E2F] text-[#C0C0C0]">
              ...
              <tr key={index} className="border-b border-gray-500/20">
                <td className="md:px-4 pl-2 md:pl-4 py-3 flex items-center space-x-3 ">
                  ...
                  <div className='flex-1'>
                    ...
                    <Line className='bg-gray-600 rounded-full' strokeWidth={2} percent={progressArray[index] ? (progressArray[index].lectureCompleted * 100) / progressArray[index].totalLectures : 0} />
                  </div>
                </td>
