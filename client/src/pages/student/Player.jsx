            ...
            {courseData && courseData.courseContent.map((chapter, index) => (
              <div key={index} className="border border-gray-500 bg-[#2E2E3A] mb-2 rounded">
                ...
                >
                  ...
                  <p className="text-sm text-gray-400">{chapter.chapterContent.length} lectures - {calculateChapterTime(chapter)}</p>
                </div>
              ...
              ? (
                <div>
                  ...
                  <div className='flex justify-between items-center mt-1'>
                    <p className='text-xl text-white'>{playerData.chapter}.{playerData.lecture} {playerData.lectureTitle}</p>
